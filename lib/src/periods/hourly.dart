...
class Hourly extends StatelessWidget implements Period {
  ...
  void handleInitialRRule() {
    if (initialRRule.contains('INTERVAL=')) {
      ...
      final interval = initialRRule.substring(intervalIndex, intervalEnd);
  ...
  String getRRule() {
    ...
    return 'FREQ=HOURLY;INTERVAL=${interval > 0 ? interval : 1}';
  }
          ...
          child: Row(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'hours', //#todo : should add it to text delegate
                  style: config.textStyle,
                ),
              ),
            ],
